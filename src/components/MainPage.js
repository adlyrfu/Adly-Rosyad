...
const MainPage = () => {
  return (
    <>
      <section id='welcome'>
        <img width='300px' height='300px' src='https://pbs.twimg.com/media/FL-M3BpVQAAjECN?format=jpg&name=900x900' />
        <h2>Adly Rosyad Fudhulul Ulwani</h2>
        <p>Undergraduate Student of Japanese Studies at Universitas Airlangga</p>
      </section>
